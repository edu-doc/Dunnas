...
<body>
    <div class="container">
        <div class="branding">Dunnas - Editar Usuário</div>
        ...
        <form action="/admin" method="get" style="margin-top:14px;">
            <div style="display:flex;justify-content:center;">
                <button type="submit" class="btn btn-voltar" style="width:100%;max-width:300px;padding:12px 0;font-size:1.15rem;">Voltar</button>
            </div>
        </form>
        </form>
    </div>
